<%--
     ...
     UBICACIÓN : Web Pages/admin/usuarios/formulario.jsp
     DESCRIPCIÓN: Formulario para crear o editar un usuario.
     Requiere utilizar los privilegios USUARIOS_CREAR o USUARIOS_EDITAR.

     VARIABLES que recibe del UsuarioServlet:
     usuario: objeto Usuario (vacío si nuevo, con datos si editar)
     roles: List<Rol> para el selector de rol
...
<%
    ...
    if (titulo  == null) titulo  = "Nuevo Usuario";

    boolean esNuevo = accion.equals("guardar");
    boolean tienePermiso = privs != null &&
        ((esNuevo  && privs.contains("USUARIOS_CREAR")) ||
         (!esNuevo && privs.contains("USUARIOS_EDITAR")));
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <% if (privs.contains("USUARIOS_VER")) { %>
                <a href="${pageContext.request.contextPath}/usuarios?accion=listar" class="nav-item activo">
        ...
        <header class="top-header">
            <div>
                ...
                <div class="header-ruta">
                    Urban Caps &rsaquo; Usuarios &rsaquo; <%= titulo %>
                </div>
            </div>
        </header>
            ...
            <div class="pagina-card">
                <div class="pagina-card-header">
                    <div>
                        ...
                        <div class="pagina-card-desc">
                            <%= esNuevo ? "Registra un nuevo miembro del equipo" : "Modifica los datos del usuario" %>
                        </div>
                    </div>
                </div>
                ...
                <form action="${pageContext.request.contextPath}/usuarios" method="post">
                    ...
                    <div class="form-cuerpo">
                        ...
                        <div class="form-grid-2">
                            <div class="form-grupo">
                                ...
                                <input type="text"
                                       ...
                                       class="form-campo"
                                       placeholder="Ej: Julia"
                                       value="<%= usuario.getNombre() != null ? usuario.getNombre() : "" %>"
                                       required maxlength="100">
                            </div>
                            <div class="form-grupo">
                                <label class="form-etiqueta" for="apellido">
                        ...
                        <%-- Email --%>
                        <div class="form-grupo">
                            <label class="form-etiqueta" for="email">
                                Correo electrónico <span style="color:var(--color-error);">*</span>
                            </label>
                            <input type="email"
                                   id="email" name="email"
                                   class="form-campo"
                                   placeholder="Ej: julia@urbancaps.com"
                        ...
                        <%-- Contraseña --%>
                        <div class="form-grupo">
                            <label class="form-etiqueta" for="password">
                                Contraseña
                                <%= esNuevo ? "<span style='color:var(--color-error);'>*</span>" : "" %>
                            </label>
                            <input type="password"
                            ...
                            <div class="form-ayuda">
                                <%= esNuevo
                                    ...
                                    : "Si dejas este campo vacío la contraseña no cambiará." %>
                            </div>
                        </div>
                        ...
                        <div class="form-grid-2">
                            <div class="form-grupo">
                                <label class="form-etiqueta" for="idRol">
                                ...
                                <select id="idRol" name="idRol"
                                    ...
                                    <%
                                        if (roles != null) {
                                            for (Rol r : roles) {
                                                String sel = (r.getIdRol() == usuario.getIdRol())
                                                             ? "selected" : "";
                                    %>
                                        <option value="<%= r.getIdRol() %>" <%= sel %>>
                                            <%= r.getNombreRol() %>
                                        </option>
                                    <% }} %>
                                </select>
                            ...
                            <div class="form-grupo">
                                ...
                                <select id="estado" name="estado" class="form-campo">
                                    <option value="1" <%= usuario.getEstado() == 1 ? "selected" : "" %>>
                                        Activo
                                    </option>
                                    <option value="0" <%= usuario.getEstado() == 0 ? "selected" : "" %>>
                                        Inactivo
                                    </option>
                                </select>
                            </div>
